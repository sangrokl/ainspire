...
VERSION_DIR = os.path.join(ROOT, "projects", "tether", "v20260620")
RAW_DIR = os.path.join(VERSION_DIR, "images")
OUTFILE = "storyboard_TETHER_30cut_v20260620.html"
ACCENT = "#caa46a"
TITLE = "TETHER · 스마트워치 — 30컷 스토리보드"
SUB = ("30컷 · 16:9 · nano_banana_2/soul_2 img2img(주인공·제품 레퍼런스 고정). "
